...
impl Scene {
    ...
    pub fn render(&mut self) {
        ...
        for i in -2..4 {
            ...
            self.objects[3].set_position(Vec3::new(1.0, 0.2, i as f32));
            ...
            let frame = Frame::from_parts(img, 0, 0, Delay::from_saturating_duration(std::time::Duration::from_millis(500)));
            frames.push(frame);
        }
